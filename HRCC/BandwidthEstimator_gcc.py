...
class GCCEstimator(object):
    def __init__(self):
        self.packets_list = []
        self.packets_group = []
        self.first_group_compete_time = -1
        ...
        self.now_ms = -1
#reset estimator by rtc_env_gcc
    def reset(self):
        self.packets_list = []
        self.packet_group = []
    ...
    def get_estimated_bandwidth(self) -> int:
        BWE_by_delay ,flag = self.get_estimated_bandiwidth_by_delay()
    ...
    def change_bandwidth_estimation(self,bandwidth_estimation):
        self.last_bandwidth_estimation = bandwidth_estimation

    def get_estimated_bandwidth_by_loss(self):
        ...
        #6. 计算带宽调整值
        bandwidth_estimation = self.rate_adaption_by_delay(state)
    ...
    def cumpute_deltas_for_pkt_group(self,pkt_group_list):
    ...
    def update_threshold(self,modified_trend,now_ms):
    ...
    def rate_adaptation_by_delay(self,state) -> int:
