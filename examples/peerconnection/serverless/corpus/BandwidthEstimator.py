...
class Estimator(object):
    def __init__(self,model_path="ppo_2024_07_23_10_34_15.pth",step_time=200):
        ...
        self.ppo = PPO(self.state_dim,self.state_length,action_dim,exploration_param,lr,betas,gamma,K_epochs,episilon,ppo_clip)
        self.ppo.policy.load_state_dict(torch.load('ppo_2024_07_23_10_34_15.pth'))
    ...
    def get_estimated_bandwidth(self)->int:
        ...
        if self.time_to_guide == True:
            ...
            self.bandwidth_prediction = self.gcc_decision * pow(2,(2*action.item() - 1))
